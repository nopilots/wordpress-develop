# Improvement Proposals - Weekly Planning #153

This document contains 3 improvement proposals and 1 governance RFC proposal per issue #153.

## Improvement #1: Test Coverage for wp_kses Security Functions

**Type:** Test coverage for complex, untested core functions
**Difficulty:** HARD - Tests governance model (Review Standards undefined)
...
## Improvement #2: Deprecation Path for Legacy Magic Quotes Functions

**Type:** Deprecation path for outdated code
**Difficulty:** HARD - Tests governance model (Backwards Compatibility decision)
**Labels:** `agent`, `status:triage`
...
**Yes** - Label `type:rfc`
This deprecation affects many plugins and requires community discussion about:
...
## Improvement #3: Security Hardening for URL Sanitization Edge Cases

**Type:** Security hardening beyond TODO fixes
**Difficulty:** MEDIUM-HARD - May need Security Review standards
**Labels:** `agent`, `status:triage`
...
## Governance RFC Proposal: Review Standards

**Type:** RFC to fill Agent-Determined gap
...
1. **Pattern observed:** Week of 2026-04-15 had 10 safety incidents - all TODO cleanup PRs stuck in review loops with >3 failed checks (per repository memory)
...
1. Are the coverage percentages (80/90/100%) appropriate?
2. Should Tier 2 PRs require specific reviewer expertise (e.g., security expert for auth changes)?
3. How to handle edge cases that don't fit tiers?
4. Should there be time-based escalation (Tier 1 -> Tier 2 if in review >48 hours)?
...
1. ✅ Test coverage for wp_kses security functions (HARD - tests governance)
2. ✅ Deprecation path for magic quotes functions (HARD - tests governance)
3. ✅ Security hardening for URL sanitization (MEDIUM - highlights governance gap)

**Governance RFC:**
1. ✅ Review Standards policy proposal

**All proposals:**
- Include clear problem statements
- Identify specific files involved
- Define test coverage requirements
- Note governance challenges
- Specify RFC requirements

Next steps: Create GitHub issues for each proposal with appropriate labels (`agent`, `status:triage`, and `type:rfc` where applicable).
